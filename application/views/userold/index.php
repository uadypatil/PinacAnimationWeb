    ...
    <style>
        ...
        */ .product-carousal .container {
        ...
        @media (max-width: 768px) {
            ...
            .product-carousal-head p.bolder {
                font-size: 14px;
                /* Adjust to make it more readable on smaller devices */
            }

            /* Add margin to the tile card for spacing */
            .tile-card {
                margin-bottom: 15px;
                /* Reduce margin to create more space on smaller screens */
            }

            /* Adjust swiper-slide width to make the slides stack correctly on smaller screens */
            .swiper-slide {
                width: 100%;
                /* Ensure the slide takes full width, adjusted for smaller screens */
                margin-right: 0;
                /* Remove the right margin to avoid spacing issues */
            }
            ...
            .slider-content p {
                font-size: 12px;
                /* Reduce font size to make it more readable on small screens */
            }
            ...
            .icon-right-arrow {
                font-size: 18px;
                /* Adjust the arrow size for smaller screens */
                display: block;
...
<body>
    ...
    <div class="position-relative overflow-hidden pt-4">
    ...
    <div class="container text-center py-5">
        <h1 class="animated-text display-4">Welcome to the Multimedia World</h1>
